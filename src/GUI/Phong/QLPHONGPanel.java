...
public class QLPHONGPanel extends JPanel {
	...
	public QLPHONGPanel() {
		...
		cbbHientrang.setBounds(520, 63, 118, 21);
		...
		JComboBox cbbHientrang_1 = new JComboBox();
		cbbHientrang_1.setModel(new DefaultComboBoxModel(new String[] {"Trống", "Đang được thuê", "Chưa dọn phòng"}));
		cbbHientrang_1.setBackground(Color.WHITE);
		cbbHientrang_1.setBounds(1020, 12, 118, 21);
		panelTimkiem.add(cbbHientrang_1);
		
		JLabel lblGiPhngT = new JLabel("Giá phòng đến:");
		lblGiPhngT.setBounds(233, 61, 95, 24);
		panelTimkiem.add(lblGiPhngT);
		
		JSpinner spinnerGiaPhongTu = new JSpinner();
		spinnerGiaPhongTu.setModel(new SpinnerNumberModel(500000, 500000, 5000000, 1000));
		spinnerGiaPhongTu.setBounds(98, 60, 106, 26);
		panelTimkiem.add(spinnerGiaPhongTu);
		
		JSpinner spinnerGiaPhongDen = new JSpinner();
		spinnerGiaPhongDen.setModel(new SpinnerNumberModel(500000, 500000, 5000000, 1000));
