...
public class Database {
    ...
    /** ___ : kiểu dữ liệu thuộc package DTO
     * toList___ : chuyển từ ResultSet sang List<T> phù hợp
     * getList___(query) : truy vấn trả về List<T> với câu query hoàn chỉnh
     * getList___(query,paramss): truy vấn trả về List<T> với câu query, kèm giá trị truyền vào
     */
